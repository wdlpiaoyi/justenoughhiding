...
public final class EmiIntentRecorder
{
    ...
    {
        addProduced(produced, source, targetOf(stack));
    }

    private static void addProduced(Map<String, Set<String>> produced, IntentSource source, IntentTarget target)
    {
        if (source == null || source.type() != IntentSource.Type.RESOURCE_PACK || target == null)
        {
            return;
        }
